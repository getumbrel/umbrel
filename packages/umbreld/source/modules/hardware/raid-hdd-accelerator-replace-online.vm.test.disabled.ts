...
describe('RAID HDD accelerator replacement with an online device', () => {
	...
	test('waits for accelerator replacement to complete while it is online', async () => {
		await pWaitFor(
			async () => {
	...
	test('reports accelerator replace events while it is online', () => {
	...
	test('reports accelerator replace status while it is online', () => {
	...
	test('reports the replacement accelerator device', async () => {
		const status = await umbreld.client.hardware.raid.getStatus.query()
