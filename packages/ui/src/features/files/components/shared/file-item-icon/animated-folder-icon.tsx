...
const folderVariants: Variants = {
	idle: {transform: 'none'},
	hover: {
		transform: 'perspective(1000px) rotateX(-30deg) translateY(6%)',
		transition,
	},
}
...
export const AnimatedFolderIcon = ({className, overlayIcon: OverlayIcon, ...props}: AnimatedFolderIconProps) => {
	return (
		<motion.div className='group relative' initial='idle' whileHover='hover'>
			<svg
				width='57'
				height='50'
				viewBox='0 0 57 50'
			...
			>
				...
				<defs>
					...
					<linearGradient id='paint0' x1='28.7064' y1='0' x2='28.7064' y2='50' gradientUnits='userSpaceOnUse'>
