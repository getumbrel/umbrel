...
export const dialogContentClass = tw`fixed left-[50%] top-[50%] z-50 flex flex-col translate-x-[-50%] translate-y-[-50%] gap-5 rounded-20 bg-dialog-content/70 contrast-more:bg-dialog-content p-8 shadow-dialog backdrop-blur-3xl contrast-more:backdrop-blur-none duration-200 outline-hidden max-h-[calc(100%-16px)]`
