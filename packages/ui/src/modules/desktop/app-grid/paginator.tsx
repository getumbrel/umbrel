...
const glassButtonCva = cva(
	'shrink-0 w-10 h-10 rounded-full backdrop-blur-sm grid place-items-center bg-white/5 shadow-glass-button text-white/75 disabled:text-white/30 transition-all hover:bg-white/10 active:bg-white/5 cursor-default',
)
