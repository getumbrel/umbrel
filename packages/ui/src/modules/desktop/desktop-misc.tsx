...
export function Search({onClick}: {onClick?: () => void}) {
	...
	return (
		<button
			className='z-10 animate-in rounded-full border border-white/5 bg-neutral-600/20 px-3 py-2.5 text-12 leading-inter-trimmed text-white/90 backdrop-blur-xs transition-colors delay-300 duration-300 fill-mode-both fade-in hover:bg-neutral-600/30 active:bg-neutral-600/10'
			onClick={onClick}
		>
