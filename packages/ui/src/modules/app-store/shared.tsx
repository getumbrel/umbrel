...
export const appsGridClass = tw`mt-[40px] grid gap-x-5 gap-y-[40px] sm:grid-cols-2 lg:grid-cols-3`
export const sectionTitleClass = tw`text-24 font-bold leading-tight md:text-32`
